...
- **수급 쏠림:** 하지만 실제 연간 총 거래대금(4,828조 원)은 **`IT/반도체`, `미디어/컨텐츠`, `기계/유틸리티`, `2차전지/화학`** 등 코스피 대형 제조업 및 주도 섹터에 극단적으로 집중되어 있습니다.
...
2. **장중 음봉 우세 (Gap-Fade):** 한국 주식시장은 시초가에 높게 떠서 시작한 뒤 장중에 매물이 출회되어 흘러내리는 경향이 강하므로, **장 시작 직후 시장가 매수는 통계적으로 손실 확률이 높습니다.**
